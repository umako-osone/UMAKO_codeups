...
<html lang="ja">
  ...
  <body>
      ...
      <div class="header__inner">
        ...
        <div class="header__drawer drawer js-drawer">
          <div class="drawer__inner">
            <nav class="drawer__nav navigation u-mobile">
    ...
    <main>
      ...
      <!-- コンタクト -->
      <section class="contact top-information-contact">
      ...
      <a href="#" class="page-top-button js-page-top"><span></span></a>
    </main>
